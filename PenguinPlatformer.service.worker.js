...
/** @type {string} */
const CACHE_VERSION = '1747973488|1020314915';
/** @type {string} */
const CACHE_PREFIX = 'Platformer-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'PenguinPlatformer.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["PenguinPlatformer.html","PenguinPlatformer.js","PenguinPlatformer.offline.html","PenguinPlatformer.audio.worklet.js","PenguinPlatformer.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["PenguinPlatformer.wasm","PenguinPlatformer.pck"];
